      ...
      <div className="fixed right-0 h-screen w-[45rem] top-0 transform  z-10   py-5 px-6 space-x-2">
        <div className="h-full w-full p-4 box-shadow-3d flex flex-col gap-4 bg-neutral-200 rounded-md">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            ...
            {user && (
              <button onClick={() => setMod(true)} className="group flex items-center gap-2 bg-gradient-to-r from-violet-500 to-violet-600 text-white px-2 py-[5px] rounded-lg hover:from-violet-600 hover:to-violet-700 transition-all duration-200 shadow-lg hover:shadow-violet-500/25">
