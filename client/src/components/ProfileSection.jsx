        ...
        {user ? (
          ...
          <button onClick={() => setShowLoginModal(true)} className="group flex flex-col items-center gap-2">
            <div className="h-8 w-8 rounded-full bg-neutral-300 flex items-center justify-center group-hover:bg-violet-600 transition-colors">
              <LogIn size={16} className="text-violet-500 group-hover:text-white" />
            </div>
            <span className="text-xs text-neutral-900 group-hover:text-violet-400 transition-colors">Login</span>
          </button>
        )}
      </div>
