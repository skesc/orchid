        ...
        {statsConfig.map((stat) => {
          ...
          return (
            <div
              ...
              <div
                className={`p-6 bg-gradient-to-r ${stat.gradient} text-white`}>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    {item.is_private ? (
                      ...
                      <span className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-emerald-100 text-emerald-600">
                        Public
                      </span>
                    )}
                  </div>
              ...
              <div className="space-y-3">
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span className="font-medium">
                      {Math.round(
                        (stats.public_items / stats.total_items) * 100,
                      )}
                      %
                    </span>
                  </div>
                  <div className="h-2 bg-neutral-200 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${(stats.public_items / stats.total_items) * 100}%`,
                      }}
                    />
                  </div>
                </div>
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span className="font-medium">
                      {Math.round(
                        (stats.private_items / stats.total_items) * 100,
                      )}
                      %
                    </span>
                  </div>
                  <div className="h-2 bg-neutral-200 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${(stats.private_items / stats.total_items) * 100}%`,
                      }}
                    />
                  </div>
                </div>
