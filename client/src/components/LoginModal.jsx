...
export default function LoginModal({isOpen, onClose}) {
  ...
  if (isAuthenticating) {
    return (
      <div className="fixed inset-0 flex items-center justify-center z-50">
        ...
        <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 m-4 max-w-md w-full transform transition-all">
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="relative w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 m-4 transform transition-all">
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            <button onClick={() => handleAuth("google")} className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-white bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 border border-gray-300 dark:border-gray-600 transition-all duration-200 group">
            ...
            <button onClick={() => handleAuth("github")} className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl text-gray-700 dark:text-white bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 border border-gray-300 dark:border-gray-600 transition-all duration-200 group">
