        ...
        {loading ? (
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl text-neutral-600 bg-neutral-300 hover:bg-violet-400 hover:text-white transition-all duration-200 group">
