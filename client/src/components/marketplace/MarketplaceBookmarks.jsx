...
export function MarketplaceBookmarks({canvas, myItems, bookmarkedItems, onToggleBookmark, onUpdate}) {
    ...
    <div className="mb-6 bg-neutral-300/50 rounded-lg p-4">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-medium text-neutral-900">Bookmarked & My Items</h3>
        </div>

        <div className="flex gap-1">
          {showLeftArrow && (
            <button onClick={() => scroll("left")} className="p-1.5 rounded-lg bg-neutral-200 text-neutral-700 hover:bg-violet-500 hover:text-white transition-colors">
              <ChevronLeft size={18} />
            </button>
          )}
          {showRightArrow && (
            <button onClick={() => scroll("right")} className="p-1.5 rounded-lg bg-neutral-200 text-neutral-700 hover:bg-violet-500 hover:text-white transition-colors">
